...
Token* AbsJumpToken::copy(CopyVisitor visitor, void* data) {
    UNUSED(visitor);
    UNUSED(data);
    return (Token*) createAbsJumpToken(this->label);
}
